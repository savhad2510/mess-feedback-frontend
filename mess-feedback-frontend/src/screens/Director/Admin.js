...
function Director() {
  ...
  return (
    <div className="admin-container">
      <h2>Campus Director Portal</h2>
      <div className="button-container">
        <button onClick={() => handleAddClick(true)}> Add Resident officer / Estate officer </button>
        <button onClick={() => handleAddClick(false)}>Add supervisor</button>
      </div>
      {showForm && (
        <div className="modal">
      ...
      <div className="dropdown">
        ...
        Resident officers {showSupervisors ? '▲' : '▼'}
        </button>
        {showSupervisors && (
          <div>
            {supervisors.map(s => (
